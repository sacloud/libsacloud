...
import (
{{- range .ImportStatementsForModelDef "github.com/sacloud/libsacloud/pkg/mapconv" "gopkg.in/go-playground/validator.v9" "github.com/sacloud/libsacloud/sacloud/accessor" }}
	{{ . }}
{{- end }}
)
