...
import (
{{- range .ImportStatements "github.com/sacloud/libsacloud/sacloud" "github.com/sacloud/libsacloud/sacloud/types"}}
	{{ . }}
{{- end }}
)
...
import (
{{- range .ImportStatements "context" "github.com/sacloud/libsacloud/sacloud" "github.com/sacloud/libsacloud/sacloud/types"}}
	{{ . }}
{{- end }}
)
...
import (
{{- range .ImportStatements "testing" "github.com/sacloud/libsacloud/sacloud" "github.com/sacloud/libsacloud/sacloud/types"}}
        {{ . }}
{{- end }}
)
