...
import (
{{- range .ImportStatements "context" "encoding/json" "github.com/sacloud/libsacloud/v2/sacloud/naked" "github.com/sacloud/libsacloud/v2/pkg/mapconv" "github.com/sacloud/libsacloud/v2/pkg/mutexkv" }}
	{{ . }}
{{- end }}
)
