...
func (s *Service) Create(req *CreateRequest) (*sacloud.Bridge, error) {
	return s.CreateWithContext(context.Background(), req)
}

func (s *Service) CreateWithContext(ctx context.Context, req *CreateRequest) (*sacloud.Bridge, error) {
	if err := req.Validate(); err != nil {
		return nil, err
	}

	params := &sacloud.BridgeCreateRequest{}
