...
func (r *UpdateRequest) toRequestParameter(current *sacloud.Bridge) (*sacloud.BridgeUpdateRequest, error) {
...
func (s *Service) Update(req *UpdateRequest) (*sacloud.Bridge, error) {
	return s.UpdateWithContext(context.Background(), req)
}

func (s *Service) UpdateWithContext(ctx context.Context, req *UpdateRequest) (*sacloud.Bridge, error) {
