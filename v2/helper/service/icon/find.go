...
func (s *Service) Find(req *FindRequest) ([]*sacloud.Icon, error) {
	return s.FindWithContext(context.Background(), req)
}

func (s *Service) FindWithContext(ctx context.Context, req *FindRequest) ([]*sacloud.Icon, error) {
	...
	found, err := client.Find(ctx, req.FindCondition)
	if err != nil {
		return nil, err
	}
	return found.Icons, nil
}
