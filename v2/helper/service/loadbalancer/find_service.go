...
func (s *Service) Find(req *FindRequest) ([]*sacloud.LoadBalancer, error) {
	return s.FindWithContext(context.Background(), req)
}

func (s *Service) FindWithContext(ctx context.Context, req *FindRequest) ([]*sacloud.LoadBalancer, error) {
