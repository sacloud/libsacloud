...
func (s *Service) Create(req *CreateRequest) (*sacloud.LoadBalancer, error) {
	return s.CreateWithContext(context.Background(), req)
}

func (s *Service) CreateWithContext(ctx context.Context, req *CreateRequest) (*sacloud.LoadBalancer, error) {
