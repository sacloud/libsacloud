...
func (s *Service) Read(req *ReadRequest) (*sacloud.AutoBackup, error) {
	return s.ReadWithContext(context.Background(), req)
}

func (s *Service) ReadWithContext(ctx context.Context, req *ReadRequest) (*sacloud.AutoBackup, error) {
