...
func (r *AddSubnetRequest) Validate() error {
	return validate.Struct(r)
}

func (r *AddSubnetRequest) toRequestParameter(current *sacloud.Internet) (*sacloud.InternetAddSubnetRequest, error) {
	req := &sacloud.InternetAddSubnetRequest{}
