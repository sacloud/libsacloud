...
type UpdateRequest struct {
	...
	UserIPAddress string `validate:"required,ipv4"`
}
...
func (r *UpdateRequest) toRequestParameter(current *sacloud.Interface) (*sacloud.InterfaceUpdateRequest, error) {
	req := &sacloud.InterfaceUpdateRequest{}
...
func (s *Service) Update(req *UpdateRequest) (*sacloud.Interface, error) {
	return s.UpdateWithContext(context.Background(), req)
}

func (s *Service) UpdateWithContext(ctx context.Context, req *UpdateRequest) (*sacloud.Interface, error) {
