...
func (s *Service) Create(req *CreateRequest) (*sacloud.Interface, error) {
	return s.CreateWithContext(context.Background(), req)
}

func (s *Service) CreateWithContext(ctx context.Context, req *CreateRequest) (*sacloud.Interface, error) {
	if err := req.Validate(); err != nil {
		return nil, err
	}

	params := &sacloud.InterfaceCreateRequest{}
