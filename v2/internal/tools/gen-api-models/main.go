...
import (
{{- range .ImportStatementsForModelDef "github.com/sacloud/libsacloud/v2/pkg/mapconv" "github.com/sacloud/libsacloud/v2/helper/validate" "github.com/sacloud/libsacloud/v2/sacloud/accessor" }}
	{{ . }}
{{- end }}
)
